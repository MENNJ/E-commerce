...
import { useOrigin } from "@/hooks/store/use-origin";
...
export const SettingsForm: React.FC<SettingsFormProps> = ({
    ...
    // Always call useForm, even if params is missing
    const form = useForm<SettingsFormValues>({
        resolver: zodResolver(formSchema),
        defaultValues: initialData
    });

    // If params are missing, return a loading or error message
    if (!params.storeId) {
        return <div>Loading...</div>;  // or you could return an error message or redirect
    }
