...
export default function StoreSwitcher({
    ...
    // Ensure params is available and formattedItems is always populated
    ...
    // Guard against missing params or storeId
    if (!params?.storeId || !currentStore) {
        return null; // or return a loading/error UI here
    }
